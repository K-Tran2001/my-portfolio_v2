  ...
  return (
    <div className="relative p-4 flex flex-col gap-4  max-w-[200px] ">
      <button
        ...
        className="select-button flex gap-2 items-center bg-[var(--body-color)] border border-gray-200 rounded-md p-2 h-11 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white z-10"
      >
      ...
      {isOpen && (
        <ul className="select-dropdown dark:bg-gray-700 bg-gray-300 rounded-sm -mt-6 pt-2 z-0">
          {languages.map((lang) => (
            <li
              key={lang.code}
              onClick={() => {
