    ...
    <div className="relative  min-h-[calc(100vh-80px)]  ">
      ...
      <div className="px-8 py-4 md:px-32 md:py-8 mt-8">
        <div className=" flex grid grid-cols-1 md:grid-cols-3 ">
          ...
          <div className="p-8 shadow-lg relative">
            ...
            <img
              ...
              srcset=""
              style={{ objectFit: "cover" }}
              className=" w-20 h-20 absolute top-0 left-0 -rotate-45 -translate-x-10 -translate-y-10"
            />
            <img
              src={bangkeo}
              alt=""
              srcset=""
              style={{ objectFit: "cover" }}
              className=" w-20 h-20 absolute right-0 bottom-0 translate-x-8 translate-y-10"
            />
          </div>
        </div>
        ...
        <div className="mt-16 md:px-8">
          ...
          <div className="mt-8">
            <div className="p-4 px-8 bg-orange-400 text-white flex justify-between rounded-l-2xl rounded-tr-2xl">
              <h3>Phoenix Company</h3>
            ...
            {expand && (
              <div className=" flex gap-8">
                ...
                <div className="p-4  flex flex-1 flex gap-2 justify-between rounded-b-2xl shadow-lg text-sm">
                  <div>
